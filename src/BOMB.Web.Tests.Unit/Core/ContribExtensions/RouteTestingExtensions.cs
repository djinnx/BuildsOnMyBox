...
//
// Modified to use Moq for HttpContextBase and HttpRequestBase
// -----------------------------------------------------------------------
...
namespace BOMB.Web.Tests.Core.ContribExtensions
{
    ...
    public static class RouteTestingExtensions
    {
        ...
        {
            var context = MockHttpContext(url, httpMethod);
        ...
        {
            var context = MockHttpContext(url, httpMethod, formMethod);
        ...
        private static HttpContextBase MockHttpContext(string url, HttpVerbs? httpMethod, HttpVerbs? formMethod)
        {
            ...
            request.Setup(x => x.HttpMethod).Returns(httpMethod.Value.ToString().ToUpper());
        ...
        private static HttpContextBase MockHttpContext(string url, string method)
        {
            var httpMethod = (HttpVerbs)Enum.Parse(typeof(HttpVerbs), method);
            return MockHttpContext(url, httpMethod, null);
        }

        private static HttpContextBase MockHttpContext(string url, HttpVerbs? httpMethod)
        {
            return MockHttpContext(url, httpMethod, null);
        }
        ...
        {
            return MockHttpContext(url, null, null);
        }

...
//
// Added ForViewEndingWith methods (for view result and partial view result) 
// due to T4MVC passing fully qualified view location
// -----------------------------------------------------------------------
...
namespace BOMB.Web.Tests.Core.Extensions
{
    ...
    public static class ActionResultHelper
    {
        ...
        /// <param name="viewName">The name of the view.</param>
        /// <returns></returns>
        public static ViewResult ForViewEndingWith(this ViewResult result, string viewName)
        {
            if (!result.ViewName.EndsWith(viewName))
            {
                throw new ActionResultAssertionException(string.Format("Expected view name '{0}', actual was '{1}'", viewName, result.ViewName));
            }
            return result;
        ...
        /// <param name="partialViewName">The name of the partial view</param>
        /// <returns></returns>
        public static PartialViewResult ForViewEndingWith(this PartialViewResult result, string partialViewName)
        {
            if (!result.ViewName.EndsWith(partialViewName))
            {
                throw new ActionResultAssertionException(string.Format("Expected partial view name '{0}', actual was '{1}'", partialViewName, result.ViewName));
            }
